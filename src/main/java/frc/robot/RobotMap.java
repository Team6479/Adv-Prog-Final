...
public class RobotMap {
  ...
  public static final int ENCODER_LEFT_ONE = 4;
  public static final int ENCODER_LEFT_TWO = 5;
  public static final int ENCODER_RIGHT_ONE = 6;
  public static final int ENCODER_RIGHT_TWO = 7;
}
